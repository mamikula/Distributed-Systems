...
@app.post("/poll")
async def create_item(item: Poll):
    return polls.append(item)


@app.get("/poll/{id}")
async def getPoll(id: int):
    return polls[id]


@app.put("/poll/{id}")
async def putPoll(item: Poll):
    return polls.append(item)


@app.delete("/poll/{id}")
async def putPoll(item: Poll):
    return polls.pop(item.id)
...
async def create_item(id: int, item: Vote):
    return polls[id].votes.append(item)


@app.get("/poll/{id}/vote/{idVote}")
async def getPoll(id: int):
    return polls[id].votes[id]


@app.put("/poll/{id}/vote/{id}")
async def create_item(id: int, idVote: int, item: Vote):
    polls[id].votes[idVote] = item



@app.delete("/poll/{id}/vote/{idVote}")
async def create_item(id: int, idVote: int):
    polls[id].votes.pop(idVote)
